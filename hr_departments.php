...
<div class="row g-4">
    <div class="col-lg-5">
        <div class="card shadow-sm"><div class="card-header bg-white"><h2 class="h6 mb-0">Grupos de departamentos</h2></div><div class="card-body">
            <form method="post" class="row g-2 mb-3"><input type="hidden" name="action" value="create_group"><div class="col-8"><input class="form-control" name="name" placeholder="Novo grupo (ex.: Qualidade)" required></div><div class="col-4 d-grid"><button class="btn btn-primary">Adicionar</button></div></form>
